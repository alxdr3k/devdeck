...
- **Project conventions**: respect `AGENTS.md` via `CLAUDE.md`, `.claude/rules/**`, and existing code style. If a review item conflicts with a project rule, flag it and follow the rule.
