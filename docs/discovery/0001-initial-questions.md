...
| Q-019 | How should DevDeck help recover "what did I ask the agent to do?" | Defer to dogfood v2. Dogfood v1 must not persist handoff text, operator notes, or chat-derived prompts as context recovery state. | open | project |
