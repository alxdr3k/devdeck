...
| TRACE-017 | Q-020 | DEC-016 proposed | REQ-021, NFR-010 | AC-024 / TEST-018 | P0-M4 | MODEL | MODEL-1A/MODEL-1B | MODEL-1A.0, MODEL-1B.3 | Dogfood v1 identity uses boilerplate leaf/slice profile; generic identity deferred. |
