...
| TRACE-017 | Q-020 | DEC-016 | REQ-021, NFR-010 | AC-024 / TEST-018 | P0-M4 | MODEL | MODEL-1A/MODEL-1B | MODEL-1A.0, MODEL-1B.3 | Dogfood v1 identity uses boilerplate leaf/slice profile; generic identity deferred. |
| TRACE-018 | Q-019 | none | REQ-022 | AC-025 / TEST-019 | dogfood v2 decision | MODEL/UI | MODEL-1D | MODEL-1D.1, MODEL-1D.2 | User instruction/context recovery is not planned for v1, including handoff/operator-note capture. |
| TRACE-019 | Q-021, Q-022 | none | REQ-023 | none yet | dogfood v2 decision | SRC/MODEL/UI | agent conversation source | not planned for v1 | Conversation tracking is deferred; v1 does not use handoffs/operator notes as conversation state. |
...
- Q-019 remains open and deferred because prior-instruction recovery, handoff capture, and operator-note capture are not part of dogfood v1.
- Q-020 is decided only for dogfood v1; generic identity/fingerprint rules remain deferred.
